...
import { Check, FileText, Mic, BarChart2, Zap, Clock } from "lucide-react"
                ...
                <div className="p-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-6">
                      <div>
                        <h4 className="text-sm text-muted-foreground mb-1">Total Issues</h4>
                        <div className="flex items-end gap-2">
                          <span className="text-5xl font-bold">12</span>
                          <span className="text-sm text-muted-foreground pb-1.5">issues detected</span>
                        </div>
                      </div>
                      
                      <div>
                        <h4 className="text-sm text-muted-foreground mb-1">Speaking Rate</h4>
                        <div className="flex items-end gap-2">
                          <span className="text-5xl font-bold">100</span>
                          <span className="text-sm text-muted-foreground pb-1.5">words per minute</span>
                        </div>
                      </div>
                      
                      <div>
                        <h4 className="text-sm text-muted-foreground mb-1">Session Details</h4>
                        <div className="bg-muted/30 rounded-lg p-3">
                          <div className="flex justify-between text-sm">
                            <span>Duration</span>
                            <span className="font-medium">2 min</span>
                          </div>
                          <div className="flex justify-between text-sm mt-2 border-t border-muted pt-2">
                    ...
                    {/* Right Column */}
                    <div>
                      <h4 className="text-sm text-muted-foreground mb-2">Top Issues</h4>
